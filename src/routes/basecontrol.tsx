...
export const Route = createFileRoute("/basecontrol")({
  ssr: false,
  head: () => ({
    meta: [
      { title: "Base Control — Safe Chain" },
    ...
    <section className="min-h-[80vh] grid lg:grid-cols-2">
      <div className="gradient-hero hidden lg:flex items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight">Safe Chain Base Control</h1>
          <p className="mt-3 text-muted-foreground">
            Restricted console for approved Safe Chain staff. Review reports, manage
            responders, and coordinate support. Access is granted after Super Admin approval.
          </p>
      ...
      <div className="flex items-center justify-center p-6 lg:p-12">
        <form onSubmit={onSubmit} className="w-full max-w-md card-soft p-8">
          <h2 className="text-2xl font-bold">Base Control sign in</h2>
          <p className="text-sm text-muted-foreground mt-1">Approved Safe Chain staff only.</p>
